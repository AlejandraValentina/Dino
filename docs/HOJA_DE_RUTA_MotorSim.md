...
| 8. Primer caso de simulación 4T | En curso — bloqueo numérico | [cuatro-tiempos-basico](../openspec/changes/cuatro-tiempos-basico/tasks.md) | Núcleo I/C/E de consola: A/B/C convergen con balances y tolerancias, pero falla tendencia de pmax/Y_I. 3 ejecuciones, 51,125 s. C50 e integración/resultados/comparación/barrido/protocolo dependientes pendientes. Sin cambiar criterios ni iniciar ejecuciones dependientes. |
