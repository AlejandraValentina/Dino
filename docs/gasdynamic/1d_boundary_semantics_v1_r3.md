# 1D_CONTRACT_V1_R3 — frontera acústica ideal

Revisión conceptual read-only aprobada por /root/p1_r3_review antes de código.
Único delta físico: cierre específico pressure-release para T05.
Los contratos v1/R2 permanecen intactos. La prueba numérica está pendiente.
...
En retorno subsónico, p_b y continuación K_i/Y_i son las tres condiciones
entrantes declaradas; J+ proviene del interior. En salida la condición acústica
entrante es p_b. No extrapolar esta idealización al transporte de reservorio.
