...
- [x] P5-C: bounded conditional exhaust integration and fixture bank; 43 focused P5B/P5C tests PASS, with restart/replay and closed-port evidence in `results/p5c-conditional-20260924/evidence.json`. Classification remains `CONDITIONAL_ON_P4`.
