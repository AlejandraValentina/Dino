...
common=dict(pathex=[str(root)],excludes=['PySide6.QtNetwork','PySide6.QtQml',
    'PySide6.QtQuick','PySide6.QtWebEngineCore','PySide6.QtTest','pywinauto','comtypes','pytest'],
    noarchive=False)
...
worker_a=Analysis([str(root/'packaging/worker_entry.py')],datas=[],
    pathex=[str(root)],excludes=['PySide6','shiboken6','pywinauto','comtypes'],noarchive=False)
